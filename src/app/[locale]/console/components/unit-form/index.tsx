...
export const UnitForm = ({
  ...
  return (
    <div className={cn('p-8 flex flex-col gap-4', interSansFont.className)}>
      ...
      <h1 className={`text-3xl leading-none ${pixelatedFont.className}`}>
        Unidades
      </h1>
      ...
      <div className="flex flex-col gap-2">
        {units.map((unit, ui) => (
          <div
            key={unit._id}
            data-remove={unit._action === 'remove' || unit._action === 'purge'}
                    ...
                    localeComponent={({ locale }) => (
                      <>
                        <Editable.Root>
                            ...
                            onSave={(value) => {
                              updateUnits({
                                ...
                                unitValue: (() => {
                                  ...
                                  const metadata = unit.title.metadata[index]
                          ...
                          <Editable.Content>
                            <h1
                              className={`text-2xl leading-none ${pixelatedFont.className}`}
                            >
                              {
                            ...
                            onSave={(value) => {
                              updateUnits({
                                ...
                                unitValue: (() => {
                                  ...
                                  const metadata = unit.prompt.metadata[index]
                ...
                <div className="mt-4">
                  <Collapsible>
                    <div className="flex items-center justify-between space-x-4 px-4">
                      <h1
                        className={`text-2xl mb-2 ${pixelatedFont.className}`}
                      >
                        Seções
                      </h1>
                              ...
                              localeComponent={({ locale }) => (
                                <>
                                  <Editable.Root>
                                    ...
                                    <Editable.Content>
                                      <h1
                                        className={`text-2xl ${pixelatedFont.className}`}
                                      >
                                        {
